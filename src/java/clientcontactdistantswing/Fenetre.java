...
// --------------------------------------------------------------------------
        ...
        panneauMail = new JPanel();
        panneauMail.setLayout(new FlowLayout(FlowLayout.LEFT));
        ...
        panneauAffichage.add(panneauMail);
...
// --------------------------------------------------------------------------
    void afficheContact(Contact contact) 
    {
